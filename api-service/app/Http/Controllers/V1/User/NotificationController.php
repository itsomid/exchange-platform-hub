...
class NotificationController extends Controller
{
     ...
     *     summary="Get count of unread user notifications",
     *     tags={"Notifications"},
     *     security={{"bearerAuth": {}}},
     *
     *     @OA\Response(
     *         response=200,
     *         description="Count of unread user notifications",
     *
     *         @OA\JsonContent(
     *             type="object",
     *
     ...
     *                 property="data",
     *                 type="object",
     *                 @OA\Property(property="count_unread", type="integer", example=10)
     *             ),
     *         )
     *     ),
     *
     ...
     *     summary="Mark a all notification as read",
     *     tags={"Notifications"},
     *     security={{"bearerAuth": {}}},
     *
     *     @OA\Response(
     *         response=200,
     *         description="Notification marked all unread as read",
     *
     *         @OA\JsonContent(
     *
     *             @OA\Property(property="message", type="string", example="Notification marked all unread as read")
     *         )
     *     ),
     *
     *     @OA\Response(
