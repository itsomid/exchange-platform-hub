...
class ApiRequest extends Model
{
    ...
    /**
     * Scope for user credit increase requests
     */
    public function scopeUserCreditIncrease($query)
    {
        return $query->where('type', ApiRequestType::USER_CREDIT_INCREASE);
    }
    ...
    /**
     * Check if request is for user credit increase
     */
    public function isUserCreditIncreaseRequest(): bool
    {
        return $this->type === ApiRequestType::USER_CREDIT_INCREASE;
    }
    ...
    {
        if (isset($this->request_data['amount'])) {
            return formatNumberTrimZeros($this->request_data['amount'], 8);
        }
        return '0';
    }
