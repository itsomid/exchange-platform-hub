...
{
    protected $fillable = [
        'user_id', 'admin_id', 'wallet_id', 'deposit_id', 'withdrawal_id', 'otc_order_id', 'spot_trade_id', 'amount', 'balance','coin_price', 'price_source_id', 'type', 'subtype', 'description', 'admin_description', 'status', 'journal_entry_number',
    ];
