                        ...
                        <div class="col mt-5">
                            ...
                            <div class="form-check form-check-inline">
                                <input name="exchange_withdrawal_type"
                                       ...
                                       id="exchange_withdrawal_period_time_checkbox" {{$exchangeWithdrawalType->value === 'exchange_withdrawal_period_time'?'checked':''}}
                                       value="exchange_withdrawal_period_time">
                                <label
                                    class="form-check-label" for="exchange_withdrawal_period_time_checkbox">برحسب زمان</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input name="exchange_withdrawal_type"
                                       class="form-check-input" type="radio"
                                       id="exchange_withdrawal_period_buy_checkbox" {{$exchangeWithdrawalType->value === 'exchange_withdrawal_period_buy'?'checked':''}}
                        ...
                        <div class="row mt-5">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <input name="exchange_withdrawal_period_time" id="exchange_withdrawal_period_time"
                                           class="form-control"
                                           placeholder="پارامتر زمان برای برداشت از صرافی مرجع"
                                           value="{{$exchangeWithdrawalPeriodTime->value}}"
                                           required>
                                    @error('otcBuyFee')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <input name="exchange_withdrawal_period_buy" id="exchange_withdrawal_period_buy"
                                           class="form-control"
                                           placeholder="پارامتر تعداد خرید برای برداشت از صرافی مرجع"
                            ...
                            <div class="row">
                                <div class="col-xl-6 mt-5">
                                    <label class="switch  switch-lg">
                                        <input type="checkbox" class="switch-input"
                                               name="exchange_withdrawal_status"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="input-group col-5">
                                            ...
                                            <span class="input-group-text">{{$walletChain->currency_chain}} </span>
                                        </div>
                                    </div>
