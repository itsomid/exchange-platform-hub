                        ...
                        <div class="row mt-5">
                            <div class="col-md-4">
                                <div class="form-group" dir="ltr">
                                    <label class="form-label" for="explorer_address_url">آدرس
                                        اکسپلورر</label>
                                    <input name="explorer_address_url" id="explorer_address_url" class="form-control"
                                        placeholder="آدرس اکسپلورر را وارد کنید." value="{{ old('explorer_address_url') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group" dir="ltr">
                                    <label class="form-label" for="explorer_tx_url">آدرس
                                        اکسپلورر تراکنش</label>
                                    <input name="explorer_tx_url" id="explorer_tx_url" class="form-control"
                                        placeholder="آدرس اکسپلورر را وارد کنید." value="{{ old('explorer_tx_url') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="min_deposit_amount" id="min_deposit_amount}" class="form-control"
                                        placeholder="حداقل مقدار واریز را وارد کنید."
                                        value="{{ old('min_deposit_amount') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="min_withdraw_amount">حداقل مقدار
                                        برداشت</label>
                                    <input name="min_withdraw_amount" id="min_withdraw_amount" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="safe_confirmations" id="safe_confirmations" class="form-control"
                                        placeholder="زمان را وارد کنید." value="{{ old('safe_confirmations') }}" required>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6 mt-5">
                                <label class="switch  switch-lg">
                                    <input type="checkbox" class="switch-input" name="deposit_enabled" value="1" />
