                    ...
                    <dd class="col-sm-7">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control font-number fw-bold" readonly="readonly"
                                dir="ltr" value="{{ formatNumberTrimZeros($exchangeBalance->getAvailable()) }}">
                    ...
                    <div class="col-xl-4 mb-4">
                        <div class="form-group">
                            ...
                            <select id="exchange_slug" class="form-select" name="exchange_slug"
                                data-placeholder="لطفا صرافی مرجع را انتخاب کنید." onchange="updateExchange()">
                    ...
                    @foreach ($walletChains as $chain)
                        <div class="col-xl-4 mb-3">
                            ...
                            <input type="text" name="withdrawal_address" id="withdrawal_address"
                                ...
                                placeholder="آدرس برداشت" disabled>
                        </div>
                        <div class="w-100"></div>
                    @endforeach
