    ...
    <div class="card mt-6">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{ route('admin.wallet.assets-gathering-to-cold-wallet') }}" class="btn btn-primary">انتقال دارایی به
                    Cold Wallet</a>
            </div>
        </div>
    </div>
                ...
                <div class="card card-action card-border-shadow-success" data-wallet-chain-id="{{ $walletChain->id }}">
                    ...
                    <div class="card-body border-top">
                        ...
                        @if (\App\Models\Currency::whereSymbol($walletChain->wallet->currency_symbol)->first()->chains->isNotEmpty())
                            <a href="javascript:void(0)" class="btn btn-primary disabled" tabindex="-1"
                                aria-disabled="true">
