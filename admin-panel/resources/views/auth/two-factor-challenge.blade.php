...
@section('content')
    ...
    <div class="authentication-wrapper authentication-cover">
        ...
        <a href="{{url('/')}}" class="app-brand auth-cover-brand">
            <span class="app-brand-logo demo">بیتکس روم</span>
            <span class="app-brand-text demo text-heading fw-bold">sss</span>
        </a>
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    ...
                    <img src="{{ asset('images/auth/bg-shape-image-light.png') }}" alt="auth-login-cover"
                         class="platform-bg">
                </div>
            </div>
            <!-- /Left Text -->
            ...
            <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
                <div
                    class="w-px-400 mx-auto mt-12 pt-5">
                    <div class="flex flex-col gap-1"><h4 class=" mui-1ji2ofx">تأیید کد دومرحله‌ای</h4>
                        <p class="MuiTypography-root mui-14ug9cz">
                            برای ورود، لطفاً کد دومرحله‌ای را از برنامه Google Authenticator خود وارد کنید.
                        </p>
                    </div>
                        <form class="flex flex-col gap-6" autocomplete="off"  action="{{route('two-factor.login')}}" id="twoStepsForm" method="POST">
                            @csrf
