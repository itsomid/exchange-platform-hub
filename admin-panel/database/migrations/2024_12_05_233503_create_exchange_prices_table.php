...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('exchange_prices', function (Blueprint $table) {
            ...
            $table->decimal('exchange_profit_sell', 6, 4)->default(0); // Profit margin or fee for the exchange
            $table->decimal('exchange_profit_buy', 6, 4)->default(0); // Profit margin or fee for the exchange
            $table->timestamps();
